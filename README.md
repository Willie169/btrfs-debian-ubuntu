...
If you are not on Kali Linux, add Kali Linux APT repo with grub-btrfs and its dependencies allowed for future updates and all other packages blocked to prevent breaking system.
```
sudo apt update
